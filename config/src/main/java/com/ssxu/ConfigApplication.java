 ...
 *                http://localhost:8091/actuator/bus-refresh  这个地址management.endpoints.web.exposure.include"*" 必须要有  不然调refresh不成功
 *                !!! {cipher} yml前后需要加单引号  propertos不需要
 *                @@@ 获取加密解密的内容的时候 暂时还没搞定加上密码去掉拦截 bootstarp.yml里面的账号密码去来  不然postman请求加密解密会被拦截
 * 创建人：徐石森
